...
def create_fondo_regre():#esta es una funcion para crear un fondo, lo que pasa es que sobrepone la imagen, utilizar para la imafen de llegada
    global Fondo
    Fondo = False
    canvas.create_image(410, 300, image=fondo_regresar)
...
#botton_mostra1r.place(x=220,y = 60)
botton_generar1 = Button(panel_control,image =Boton5,command=accion_enganchar_final,bg="gray",bd=0)
botton_generar1.place(x=220,y = 20)
botton_generar2 = Button(panel_control,image =Boton7,command=accion_enganchar_medio,bg="gray",bd=0)
botton_generar2.place(x=150,y = 20)
botton_mostrar3 = Button(panel_control,image = Boton1,command=accionBotonDibujar,bg="gray",bd=0)
botton_mostrar3.place(x=10,y = 20)
#botton_mostrar4 = Button(panel_control,image=Boton3,command=accionBotonSalida,bg="gray",bd=0)
#botton_mostrar4.place(x=290,y = 20)
botton_mostrar5 = Button(panel_control,image=Boton4,command=trenes[j].llegada_Tren,bg="gray",bd=0)
botton_mostrar5.place(x=360,y = 20)
botton_mostrar6 = Button(panel_control,image=Boton8,command=swith_M,bg="gray",bd=0)
botton_mostrar6.place(x=430,y = 20)
botton_mostrar7 = Button(panel_control,image=Boton2,command=quitar_vagon,bg="gray",bd=0)
botton_mostrar7.place(x=570,y = 20)
botton_mostrar8 = Button(panel_control,image=Boton9,command=swith_A,bg="gray",bd=0)
botton_mostrar8.place(x=500,y = 20)
botton_mostrar9 = Button(panel_control,image=Boton3,command=trenes[j].Salida,bg="gray",fg="white")
botton_mostrar9.place(x=290,y = 20)
